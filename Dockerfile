...
COPY target/SpringBootRolePlay-1.0-SNAPSHOT.jar /usr/app/SpringBootRolePlay-1.0-SNAPSHOT.jar

# Define el punto de entrada de la aplicación
ENTRYPOINT ["java", "-jar", "/usr/app/SpringBootRolePlay-1.0-SNAPSHOT.jar"]
